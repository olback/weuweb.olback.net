                ...
                <div class="card card-block">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input id="name" readonly="readonly" class="form-control" placeholder="Name" type="text" value="<?php echo $_SESSION['name'];?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input id="class" readonly="readonly" class="form-control" placeholder="Class" type="text" value="<?php echo $_SESSION['class'];?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input id="email" readonly="readonly" class="form-control" placeholder="Email" type="email" value="<?php echo $_SESSION['email'];?>">
